...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("page_id", sa.BigInteger(), sa.ForeignKey("documents.page_id", ondelete="CASCADE"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("run_id", sa.BigInteger(), sa.ForeignKey("ingestion_runs.run_id", ondelete="CASCADE"), nullable=False),
    ...
    op.create_index("idx_document_chunks_page_chunk", "document_chunks", ["page_id", "chunk_index"], unique=False)
